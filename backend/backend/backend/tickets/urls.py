...
from .views import (
    ...
    TicketTypeAdminListCreateAPIView, TicketTypeAdminDetailAPIView,
    RequestTypeAdminListCreateAPIView, RequestTypeAdminDetailAPIView
)
...
urlpatterns = [
    ...
    # --- Admin CRUD ---
    path('admin/ticket-types/', TicketTypeAdminListCreateAPIView.as_view(), name='admin-ticket-types'),
    path('admin/ticket-types/<int:id>/', TicketTypeAdminDetailAPIView.as_view(), name='admin-ticket-types-detail'),
    path('admin/request-types/', RequestTypeAdminListCreateAPIView.as_view(), name='admin-request-types'),
    path('admin/request-types/<int:id>/', RequestTypeAdminDetailAPIView.as_view(), name='admin-request-types-detail'),
]