...
from .models import Ticket, TicketComment, TicketAuditLog, TicketType, RequestType
...
class TicketTypeAdminListCreateAPIView(generics.ListCreateAPIView):
    queryset = TicketType.objects.all().order_by('name')
    serializer_class = TicketTypeSerializer
    permission_classes = [IsSuperUser]


class TicketTypeAdminDetailAPIView(generics.RetrieveUpdateDestroyAPIView):
...
class RequestTypeAdminListCreateAPIView(generics.ListCreateAPIView):
    queryset = RequestType.objects.select_related('ticket_type').order_by('ticket_type__name', 'name')
    serializer_class = RequestTypeSerializer
    permission_classes = [IsSuperUser]


class RequestTypeAdminDetailAPIView(generics.RetrieveUpdateDestroyAPIView):
    queryset = RequestType.objects.select_related('ticket_type')
    serializer_class = RequestTypeSerializer
    permission_classes = [IsSuperUser]
    lookup_field = 'id'
